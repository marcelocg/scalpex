defmodule Scalpex.System do
  @moduledoc """
  This file was shamelessly partialy borrowed from the woderful Bechee project
  Original: https://github.com/PragTob/benchee/blob/master/lib/benchee/system.ex
